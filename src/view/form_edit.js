...
import {humanizeTripTimeEdit} from '../util/utils.js';
...
const createAvaibleOffers = (offer) => {
  ...
  for (let i = 0; i < offerByType.length; i++){
    avaibleOffers.push(`<div class="event__offer-selector">
      <input class="event__offer-checkbox  visually-hidden" id="${offerByType[i].id}" type="checkbox" name="${offerByType[i].id}" checked>
    ...
    <form class="event event--edit" action="#" method="post">
      <header class="event__header">
        ...
        <div class="event__field-group  event__field-group--time">
          ...
          <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value='${humanizeTripTimeEdit(dateFrom)}'>
          &mdash;
          <label class="visually-hidden" for="event-end-time-1">To</label>
          <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value='${humanizeTripTimeEdit(dateTo)}'>
        </div>
...
export default class FormEditView extends AbstractView{
  ...
  #formSubmitHandler = (evt) => {
    evt.preventDefault();
    this.#handelOnFormSubmit(this.#point);
  };
}
